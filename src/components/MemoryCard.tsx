...
export function MemoryCard({
  ...
  return (
    <article className="group border border-hairline bg-surface p-3 transition-colors hover:border-synapse/40 hover:bg-surface-raised">
      ...
      <div className="mt-3 flex items-center justify-between gap-3 border-t border-hairline pt-2.5 text-xs text-ink-600">
